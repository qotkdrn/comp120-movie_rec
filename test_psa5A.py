...
def test_psa4():
    ...
    try:
        ...
        mr = movie_recommendations.Movie_Recommendations(
            "dummy_movies.csv", "dummy_training_ratings.csv")        #import file -> grab movie_dict from file
        md = mr.movie_dict
        if set(range(1, 6)) != set(md):                              #movie_dict should have 5 keys {1,2,3,4,5}             
    ...
    # Test predict_rating with a valid user id and valid movie id
    num_tested += 1
    ...
    if num_correct == num_tested:
        ...
        print("movie database by running test_psa5B.py.")
    else:
